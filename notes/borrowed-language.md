# Borrowed Language Registry

Device (approved 2026-07-08): after Farrell reads Morrow's journal, Morrow's
phrasing may surface in Farrell's narration — the borrowed simile is diegetic,
a man's head full of another man's language. This file tracks every instance so
...
date.** Morrow's side must also precede the echo in journal-time (it always
does — the whole journal predates the reading).

## Sanctioned echoes (grounded)
...
| "wonder" (the settlers' hypothesized seeing) | 14:55 ("observe her and wonder at her strangeness and go about their business") | 20:41 ("watching the white buffalo without wonder") | ADDED 2026-07-12 (DK line-iteration; replaced "unimpressed" after ngram check — deadpan sense is 1920s+). THE REFUTATION ECHO: wonder is Morrow's own predicted word for the settlers' seeing — the best case he refused to risk. The fever runs the experiment and reports it below his floor: not wonder-then-indifference, nothing. Grounded (post-reading). Borrow count: four, this one adversarial — the only echo that answers the journal rather than absorbing it. EXEMPT from the wire: 16:37 (buffalo-wonders, verb, her wondering not theirs) and Morrow's ambient "I wonder" musing tic |
...
- When editing Parts Two–Five, any newly noticed shared phrase gets a row here
  before it gets a fix — classify first (grounded / candidate / bleed).
- After any timeline change, re-verify the reading night's date and that every
